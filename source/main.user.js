            ...
            for (const [key, value] of Object.entries(mObj)) {
                try {
                    if (
                        ...
                        if (
                            checkUser(value.lastUpdate.co, value.lastUpdate.cs)
                        ) {
                            // console.log(key)
        ...
        document
            ...
            .addEventListener("click", function () {
                if (
                    ...
                    airportElmnt.childNodes[1].classList.add(
                        "ext-highlighted2",
                    );
                    setTimeout(() => {
                        airportElmnt.childNodes[1].classList.remove(
                            "ext-highlighted2",
                        );
